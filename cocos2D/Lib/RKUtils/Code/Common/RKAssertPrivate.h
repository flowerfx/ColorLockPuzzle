...
#include "OOPPSS  RKTARGET not defined!"
	...
	typedef signed short 					s16;			///<signed 8 bit value
	typedef float               	f32;			///<float value
	typedef unsigned short 				f16;			///< half float unsigned 16 bit value
	typedef unsigned int 				u32;
	typedef signed int 					s32;
	typedef unsigned __int64 		u64;
	typedef signed __int64 			s64;
	typedef unsigned __int64 		nptr;
#else
	//.. to check / customize ..
	typedef unsigned char 				u8;				///<unsigned 8 bit value
	typedef signed char 					s8;				///<signed 8 bit value
	...
	typedef unsigned int 				u32;
	typedef signed int 					s32;
	//typedef unsigned __int64 		u64;    //not on android ..
	//typedef signed __int64 			s64;
	//typedef unsigned __int64 		nptr;
#endif
...
#define RKSA_typeID(x) sizeof(*RKSA_typeof_fct(x))
	...
	RKSA_REGISTER_TYPE(1, char)
		...
		//RKSA_REGISTER_TYPE( 17, u8 )
		//RKSA_REGISTER_TYPE( 17, s8 )
		//RKSA_REGISTER_TYPE( 22, u16 )
		//RKSA_REGISTER_TYPE( 20, s16 )
		//RKSA_REGISTER_TYPE( 20, u32 )
		//RKSA_REGISTER_TYPE( 20, s32 )
		//RKSA_REGISTER_TYPE( 20, f32 )
		//RKSA_REGISTER_TYPE( 20, u64 )		//   if needed, must change RKArgument::value to be 64 bits !
		//RKSA_REGISTER_TYPE( 20, s64 )

		RKSA_REGISTER_TYPE( 17, u8 *)
		RKSA_REGISTER_TYPE( 18, s8 *)
		RKSA_REGISTER_TYPE( 19, u16 *)
		RKSA_REGISTER_TYPE( 20, s16 *)
		RKSA_REGISTER_TYPE( 21, u32 *)
		RKSA_REGISTER_TYPE( 22, s32 *)

		//#if (MLTARGET!=MLTARGET_DS)		//f32 is unsigned int
		RKSA_REGISTER_TYPE( 23, f32 *)
		//#endif
