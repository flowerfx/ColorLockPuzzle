...
namespace Utility
{
	namespace IAP
	{
		...
		private:
            ...
            RKUtils::RKThread * p_ThreadCheckFulfillment;
            ...
            static uint32 checkFulfillment_thread(void * data);
		...
		public:
            ...
            bool OnCheckFullfilmentComplete() { return p_IsCheckFulfillmentComplete;}
...
#define IAPMgr IAP::IAPManager::GetInstance()
