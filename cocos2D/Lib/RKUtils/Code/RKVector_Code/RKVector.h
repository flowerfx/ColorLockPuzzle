...
namespace RKUtils
{
	...
	struct RKVector
	{
		...
		static float    AngleBetween(const RKVector& v1, const RKVector& v2)         { return acos(Dot(v1, v2)); }
...
#include<arm_neon.h>
	...
	struct RKVector2
	{
		...
		static float AngleBetween(const RKVector2& v1, const RKVector2& v2) { return acos(Dot(v1, v2)); }
