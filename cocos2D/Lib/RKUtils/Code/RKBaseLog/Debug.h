...
#elif defined(OS_W8) || defined OS_WP8
#	if defined(_DEBUG)
...
#	define PDBG(...) ((void)__android_log_print(ANDROID_LOG_INFO, "GAME", __VA_ARGS__))
#	define PINFO(...) ((void)__android_log_print(ANDROID_LOG_INFO, "GAME", __VA_ARGS__))
#	define PWARN1(...) ((void)__android_log_print(ANDROID_LOG_INFO, "GAME", __VA_ARGS__))
#	define PWARN2(...) ((void)__android_log_print(ANDROID_LOG_INFO, "GAME", __VA_ARGS__))
#	define PWARN3(...) ((void)__android_log_print(ANDROID_LOG_INFO, "GAME", __VA_ARGS__))
#	define PERR(...) ((void)__android_log_print(ANDROID_LOG_INFO, "GAME", __VA_ARGS__))
//#elif defined OS_IOS
//#	define PDBG(msg, ...)
//#	define PINFO(msg, ...)
//#	define PWARN1(msg, ...)
